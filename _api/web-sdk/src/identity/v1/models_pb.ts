...
// @generated from file identity/v1/models.proto (syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export class IdentityProfile extends Message<IdentityProfile> {
  ...
  /**
   * @generated from field: string profile_email = 4;
   */
  profileEmail = "";
  ...
  profile: {
    /**
     * @generated from field: GoogleProfile google = 5;
     */
    value: GoogleProfile;
    case: "google";
  } | {
    /**
     * @generated from field: GithubProfile github = 6;
     */
    value: GithubProfile;
    case: "github";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "profile_email", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 5, name: "google", kind: "message", T: GoogleProfile, oneof: "profile" },
    { no: 6, name: "github", kind: "message", T: GithubProfile, oneof: "profile" },
  ]);
