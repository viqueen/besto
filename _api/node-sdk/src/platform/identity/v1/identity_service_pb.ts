...
/**
 * @generated from message GetIdentityRequest
 */
export class GetIdentityRequest extends Message<GetIdentityRequest> {
  ...
  static readonly typeName = "GetIdentityRequest";
...
/**
 * @generated from message GetIdentityResponse
 */
export class GetIdentityResponse extends Message<GetIdentityResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "GetIdentityResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
