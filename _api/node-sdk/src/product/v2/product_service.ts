...
export namespace product.v2 {
    ...
    export class GetProductResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            product?: dependency_1.product.v2.Product;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get product() {
            return pb_1.Message.getWrapperField(this, dependency_1.product.v2.Product, 1) as dependency_1.product.v2.Product;
        }
        set product(value: dependency_1.product.v2.Product) {
        ...
        static fromObject(data: {
            product?: ReturnType<typeof dependency_1.product.v2.Product.prototype.toObject>;
        }): GetProductResponse {
            const message = new GetProductResponse({});
            if (data.product != null) {
                message.product = dependency_1.product.v2.Product.fromObject(data.product);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetProductResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.product, () => message.product = dependency_1.product.v2.Product.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export abstract class UnimplementedProductServiceService {
        static definition = {
            GetProduct: {
                path: "/product.v2.ProductService/GetProduct",
                requestStream: false,
